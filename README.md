...
1. Maak wijzigingen in de [frontend](frontend) folder
2. Test lokaal met `npm run dev` in de frontend folder
3. Build de frontend met `npm run build` (dit kopieert automatisch naar backend)
4. Start de backend met `npm run dev` of `npm start` in de backend folder
